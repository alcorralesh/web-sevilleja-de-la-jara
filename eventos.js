...
document.addEventListener('click',event=>{const signup=event.target.closest('.signup-open');if(signup)openSignup(signup.dataset.id);if(event.target.closest('[data-close]'))closeModal()});
